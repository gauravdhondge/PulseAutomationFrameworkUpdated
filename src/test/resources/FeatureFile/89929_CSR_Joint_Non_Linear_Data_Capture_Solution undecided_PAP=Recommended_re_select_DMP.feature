...
Then User fills the Debt Details for Client and assert Total Amount "91600"
        | creditor            | debttype        |      amountOwed  | liability |  areYouBehindWithPayments |furtherAction |furtherActionType |haveYouRepaidAnyArrearsInTheLast12Months |originalReGularPayment|originalReGularPaymentForEvery|isthedebtsubjecttoaguarantor|isDebtTypeMortagage|whatTypeOfMortgageIsIt|isItOnaStandardVariableRate|mortagagePaymentAmount|mortagagePaymentFrequency|ownerOfPayment|linkMainHome|linkAssets|assetWorth|ownerOfTheAsset|isClientLiableForAllPayments|
        | Argos               |  Store card     |      100         | 1         |  Yes                      |      Yes     |   Default notice |false                                    |false                 |4                             |No                          |false              |0                     |false                      |0                     |0                        |3             |false       |false     |false     |false          |false                       |
        | Next                |  Catalogue      |      1500        | 2         |  Yes                      |      Yes     |   Default notice |false                                    |false                 |4                             |No                          |false              |0                     |false                      |0                     |0                        |1             |false       |false     |false     |false          |false                       |
        | HSBC                |  Mortgage       |      90000       | 3         |  No                       |      No      |   false          |Yes                                       |false                 |4                             |No                          |true               |2                     |No                         |310                   |4                        |3             |true        |false     |170000    |3              |false                       |
...
And Navigate to the Your Spendings Fixed page and enter the data as DataTable and Assert Total Fixed Spendings as "831.12"
    ...
    | Council tax                     | 115.87    |        4    |     No      |
    | TV licence                      | 13.25     |        3    |     No      |
    | Electricity                     | 71        |        4    |     No      |
    | Gas                             | 50        |        4    |     No      |
    | Water supply                    | 46        |        4    |     false   |
