...
#  And Select PhoneCall Option
  ...
  Then User fills the Debt Details for Client and assert Total Amount "5500"
  ...
  And Navigate to the Income page and enter the data as DataTable and Assert Total Income as "780.26"
    ...
    | Wage                                    | 300.13    |        4    |
  And Navigate to the Your Spendings Fixed page and enter the data as DataTable and Assert Total Fixed Spendings as "741.00"
  ...
  And User clicks on continue The screen
  And Navigate to the Your Spendings Flexible page and enter the data as DataTable and Assert The totatl Spedings As "312.00"
    | field                              | amount    |      index  |   arrears      |
    | Groceries                          | 235       |        5    |     false      |
...
#  And User Ends the ses sion and Logout from the Application
