Feature: Validation of E2E scenario 89963
  ...
  Scenario: Validate E2E scenario 89963
    ...
    Then User fills the Debt Details Online for Client and assert Total Amount "3600"
    ...
    And User Navigate to Creating your budget from dashboard and Click on Continue
