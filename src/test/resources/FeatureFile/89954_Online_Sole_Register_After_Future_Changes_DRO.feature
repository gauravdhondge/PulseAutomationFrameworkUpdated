Feature: Validation of E2E scenario 89954
  ...
  Scenario: Validate End TO End 89954 scenario
    ...
    Then User fills the Debt Details Online for Client and assert Total Amount "16200"
  ...
  #    | Lowell        |  Insurance arrears   |      1800        | You       |  false                   |false               |      false   |   No action taken (arrears only) |  false               |4                             |No                          |false              |0                     |false                      |0                     |0                        |false     |false     |false          |false                       |No                       |Buildings and contents insurance|25         |
    ...
    And Navigate to the Online Income page and enter the data as below Assert Total Income as "600.00"
    ...
    And Navigate to the Online Spendings Fixed page and enter the data as below Assert Total Income as "1675.00"
      ...
      |Home and contents          |Electricity      |30         |4            |No       |false           |HSBC    |Mortgage|Client1    |90000          |No                   |Repayment     |No   |No      |170000    |Client1      |
      ...
      |Utilities                  |Water supply     |30         |5            |false    |false           |HSBC    |Mortgage|Client1    |90000          |No                   |Repayment     |No   |No      |170000    |Client1      |
