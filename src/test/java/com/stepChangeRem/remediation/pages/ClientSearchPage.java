...
//	YouAreAllDonePage youAreAllDone=new YouAreAllDonePage();
	...
	private Button AddTaskhome;

	private Button DebtAdvice;
...
//	private Link getfirstNameRowClick() {return firstNameRowClick;}
	...
	public Button getAddTaskhome() { return AddTaskhome;}
	public Button getDebtAdvice() { return DebtAdvice;}
	public Button getAddTask() { return AddTask;}
	...
	public ClientSearchPage()
	{
		...
		AddTaskhome=new Button(By.xpath("(//button[@class='SC_Button_Tertiary pzhc pzbutton'])[1]"));
		DebtAdvice=new Button(By.xpath("(//a[text()='Debt Advice'])[1]"));
		AddTask=new Button(By.xpath("//button[text()='Add tasks']"));

		selectCaseTypeOption=new Button(By.xpath("//a[contains(text(),'Select case type ')]"));
		createNewDebtAdviceCaseButton =new Button(By.xpath("//span[text()='Create new debt advice case']"));
...
//		getBrowser().sleep(getBrowser().getTimeout());
		...
		Thread.sleep(4000);
//		this.getAddTaskhome().click();
//		Thread.sleep(3000);
//		this.getDebtAdvice().click();
//		Thread.sleep(3000);
//		this.getAddTask().click();
//		getBrowser().sleep(getBrowser().getTimeout());

	}

//	public void AddtaskProcess() throws InterruptedException {
//
//		Thread.sleep(3000);
//		getDriver().switchTo().frame("PegaGadget1Ifr");
//		Thread.sleep(3000);
//		this.getAddTaskhome().click();
//		Thread.sleep(3000);
//		this.getDebtAdvice().click();
