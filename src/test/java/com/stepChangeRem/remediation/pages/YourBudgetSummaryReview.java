...
public class YourBudgetSummaryReview extends Control{
	...
	public YourBudgetSummaryReview() {
		...
		BudgetSummaryContinueButton =new Button(By.xpath("//button[text()='Continue']"));
...
//	}
	...
	public void ClickContinueOnBudgetSummarypage89930()
	{
		genericMethodsCvp.implicitWait(5000);
		switchToActiveFrame();
		this.getBudgetSummaryContinueButton().click();
	...
	public void ClickContinueOnBudgetSummarypage89949()
	{
		genericMethodsCvp.implicitWait(5000);
		switchToActiveFrame();
		this.getBudgetSummaryContinueButton().click();
