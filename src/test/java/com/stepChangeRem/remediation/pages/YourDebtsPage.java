...
public class YourDebtsPage extends Control {
    ...
    private final Link BackToDashBordLink;
    ...
    private final AutoComplete CreditorFromutoComplete2;


    private final AutoComplete CreditorFromutoCompleteBritishGas;
    private final AutoComplete DebtTypFromAutoComplete;

    private final AutoComplete DebtTypFromAutoComplete2;


    private Dropdown DebtTypeFromAutoCompleteNatwest2;

    private final AutoComplete DebtTypFromAutoCompleteBritishGas;
    private final TextField AmountOwedTextField;

    private final TextField AmountOwedTextFieldBritishGas;
    private final TextField AmountOwedTextFieldNatwest;
    private final Dropdown LiabilityutoComplete;

    private final Dropdown LiabilityutoComplete2;

    private final Dropdown LiabilityComplete2;

    private final Button ArrearsOrFurtherActionNoButton89939;
    ...
    private final Button AreYouBehindWithpayementNoButton89939;

    private final Button ContinueButtonyourDebtPage89939;
    ...
    private Button ActionTakenByCreditor;

    private Button FurtherActionNatwestNo;
    ...
    private Dropdown CreditorFromAutoCompleteNatwest2;
    ...
    private TextField AmountOwnedTextBoxNatwest2;
    ...
    public Link getBackToDashBordLink() {
    ...
    public Button getAreYouBehindWithpayementNoButton89939() {
        return AreYouBehindWithpayementNoButton89939;
    }

    public Button getContinueButtonyourDebtPage89939() {
        return ContinueButtonyourDebtPage89939;
    }
    ...
    public AutoComplete getCreditorFromutoComplete2() {
        return CreditorFromutoComplete2;
    }

    public AutoComplete getCreditorFromutoCompleteBritishGas() {
        return CreditorFromutoCompleteBritishGas;
    }
    ...
    public AutoComplete getDebtTypFromAutoComplete2() {
        return DebtTypFromAutoComplete2;
    }

    public AutoComplete getDebtTypFromAutoCompleteBritishGas() {
        return DebtTypFromAutoCompleteBritishGas;
    }
    ...
    public TextField getAmountOwedTextFieldNatwest() {
        return AmountOwedTextFieldNatwest;
    }

    public TextField getAmountOwedTextFieldBritishGas() {
        return AmountOwedTextFieldBritishGas;
    }
    ...
    public Dropdown getLiabilityutoComplete2() {
        return LiabilityutoComplete2;
    }
    ...
    public Button getArrearsOrFurtherActionNoButton89939() {
        return ArrearsOrFurtherActionNoButton89939;
    }
    ...
    public Button getActionTakenByCreditor() {
        return ActionTakenByCreditor;
    }

    public Button getFurtherActionNatwestNo() {
        return FurtherActionNatwestNo;
    }
    ...
    public Dropdown getCreditorFromAutoCompleteNatwest2(){

        return getCreditorFromAutoCompleteNatwest2();
    }
    ...
    public TextField getAmountOwnedTextBoxNatwest2() {
        return AmountOwnedTextBoxNatwest2;
    }
...
//	private Button NoFurtherAction;
    ...
    public YourDebtsPage() {
        ...
        BackToDashBordLink = new Link(By.xpath("//a[contains(text(),'Back to dashboard')]"));
        ...
        CreditorFromutoComplete2 = new AutoComplete(By.xpath("(//input[@placeholder='Creditor'])[2]"));
        CreditorFromutoCompleteBritishGas = new AutoComplete(By.xpath("(//input[@placeholder='Creditor'])[2]"));
        CreditorFromutoComplete = new AutoComplete(By.xpath("(//input[@placeholder='Creditor'])[1]"));
       CreditorFromAutoCompleteNatwest2=new Dropdown(By.xpath("(//input[@placeholder='Creditor'])[2]"));
        DebtTypFromAutoCompleteBritishGas = new AutoComplete(By.xpath("(//input[@placeholder='Debt type'])[2]"));
        DebtTypFromAutoComplete = new AutoComplete(By.xpath("(//input[@placeholder='Debt type'])[1]"));
        DebtTypFromAutoComplete2 = new AutoComplete(By.xpath("(//input[@placeholder='Debt type'])[2]"));
        AmountOwedTextFieldBritishGas = new TextField(By.xpath("//input[contains(@name,'$ppxResults$l2$pArrearsBalance')]"));
        AmountOwedTextFieldNatwest = new TextField(By.xpath("//input[contains(@name,'$ppxResults$l1$pAmountOwed')]"));
         AmountOwedTextField = new TextField(By.xpath("//input[contains(@name,'$ppxResults$l1$pAmountOwed')]"));
//        AmountOwedTextField = new TextField(By.xpath("//input[@placeholder='£']"));
        LiabilityutoComplete2 = new Dropdown(By.xpath("//select[contains(@name,'$ppxResults$l2$pOwnership$pCode')]"));

//        LiabilityutoComplete2 = new Dropdown(By.xpath("//option[@value='OWN0001']//parent::select"));//select[@data-ctl='[\"Dropdown\"]']
        ...
        ArrearsOrFurtherActionNoButton89939 = new Button(By.xpath(""));
        ...
        ActionTakenByCreditor = new Button(By.xpath("//label[text()='Default notice']"));
        FurtherActionNatwestNo = new Button(By.xpath("(//label[text()='No'])[1]"));
        ...
        AmountOwedTextbox89949 = new TextField(By.xpath("(//input[@placeholder='£'])[1]"));
        ...
        AmountOwnedTextBoxNatwest2=new TextField(By.xpath("//input[contains(@name,'$ppxResults$l2$pAmountOwed')]"));
        AmountOwedTextbox2 = new TextField(By.xpath("//input[contains(@name,'$ppxResults$l2$pAmountOwed')]"));
//        AmountOwedTextbox2 = new TextField(By.xpath("(//input[@placeholder='£'])[2]"));
        ...
        AmountOwedTextbox2MPA = new TextField(By.xpath("(//input[@placeholder='£'])[2]"));
...
//		DetailedViewLink2 = new Link(By.xpath("(//a[text()='Detailed view'])[2]"));
        ...
        AmountOwedTextbox3 = new TextField(By.xpath("//input[contains(@name,'$ppxResults$l3$pAmountOwed')]"));
        ...
        AmountOwedTextbox4 = new TextField(By.xpath("(//input[@placeholder='£'])[4]"));
        ...
        creaditorDropDownValueButton = new Button(By.xpath("//div[text()='Natwest']"));
 //       creaditorDropDownValueButton = new Button(By.xpath("//div[@class='cellIn']"));
        DebtTypeDropDownValueButton = new Button(By.xpath("//span[text()='Credit card']"));
//        DebtTypeDropDownValueButton = new Button(By.xpath("//span[@class='ac-primary-option']"));
        ...
        AreYouBehindWithpayementNoButton89939=new Button(By.xpath("(//label[@class='rb_segmented rb_standard radioLabel'])[2]"));
        ContinueButtonyourDebtPage89939=new Button(By.xpath("(//button[text()='Continue'])[2]"));
    ...
    public void EnterCreditor1Details89937() throws InterruptedException {
        GenericMethod_cvp.implicitWait(2000);
...
//        creaditorDropDownValueButton.click();
        ...
        this.enter();
//        DebtTypeDropDownValueButton.click();
        this.getAmountOwedTextFieldNatwest().clear();
        (new WebDriverWait(getDriver(), 30)).until(ExpectedConditions.elementToBeClickable(getLiabilityutoComplete().getSelector()));
        this.getAmountOwedTextFieldNatwest().enterTextField("2800");
        GenericMethod_cvp.selectByIndex(LiabilityutoComplete, 1);
//        this.getArrearsOrFurtherActionNoButton().click();
 //       GenericMethod_cvp.implicitWait(4000);
//        this.getDetailedViewLink().click();
        ...
        GenericMethod_cvp.implicitWait(4000);
        this.getActionTakenByCreditor().click();
//        this.getFurtherAction1().click();
        GenericMethod_cvp.implicitWait(4000);
        this.getFurtherActionNatwestNo().click();
        GenericMethod_cvp.implicitWait(4000);
        ...
        //ClickAddaDebtButton();
        GenericMethod_cvp.implicitWait(5000);
        this.getCreditorFromutoCompleteBritishGas().enterTextThenSelectFromAutoComplete("British Gas");
        this.enter();
//        creaditorDropDownValueButton.click();
        GenericMethod_cvp.implicitWait(5000);
        this.getDebtTypFromAutoCompleteBritishGas().enterTextThenSelectFromAutoComplete("Gas arrears");
        this.enter();
//        DebtTypeDropDownValueButton.click();

        this.getAmountOwedTextFieldBritishGas().clear();
        (new WebDriverWait(getDriver(), 30)).until(ExpectedConditions.elementToBeClickable(getLiabilityComplete2().getSelector()));
        this.getAmountOwedTextFieldBritishGas().enterTextField("3000");
        GenericMethod_cvp.implicitWait(5000);
...
//        this.getDetailedViewLink2().click();
        ...
        GenericMethod_cvp.implicitWait(5000);;//till here debt 2 details
        this.getAllofClientsDebtshavebeencapturedCheckBox().click();
        GenericMethod_cvp.implicitWait(4000);
        this.getIstheDebtSubjectToAGuarantorNoButton().click();
        GenericMethod_cvp.implicitWait(4000);
...
//        this.getCreditorFromutoComplete().tab();
 ...
 //       this.getDebtTypFromAutoComplete().enterText("personal loan");
        this.getDebtTypFromAutoComplete().enterTextThenSelectFromAutoComplete(DebtType1Name);
        this.enter();
        GenericMethod_cvp.implicitWait(5000);
//        GenericMethod_cvp.verifyOverLayDisplayed();
//        GenericMethod_cvp.implicitWait(5000);
...
//        GenericMethod_cvp.implicitWait(10000);
        this.EnterAmountOwedinTextField(AmountOwedValue1);
...
//        GenericMethod_cvp.implicitWait(4000);
//        getDriver().findElement(By.xpath("(//label[@class=' cb_standard'])[3]")).click();
//
//        GenericMethod_cvp.implicitWait(3000);
//        this.getAreYouBehindWithpayementNoButton89939().click();
//        GenericMethod_cvp.implicitWait(3000);
//        this.getDoTheyGuarantorWhoWillBecomeResponsibleNoButton().click();
//        GenericMethod_cvp.implicitWait(3000);
//        this.getDoTheyDisputeBalanceNoButton().click();
...
//		this.getAmountOwedTextbox2().clickScreenElement(this.getAmountOwedTextField().getElement());
    ...
    public void debtsWithCreditorsforJointMPA() {
        ...
        //Creditor1
        GenericMethod_cvp.implicitWait(20000);
        this.getCreditorFromDropDown2MPA().enterCharByChar("HSBC");
        this.gettabClick().click();
        GenericMethod_cvp.implicitWait(6000);
        this.getDebtTypFromDropdown2MPA().enterCharByChar("Personal loan");
        tabdebtsPrimary.click();
        GenericMethod_cvp.implicitWait(8000);
        this.getAmountOwedTextbox2MPA().enterText("4000");
        GenericMethod_cvp.implicitWait(6000);
//        this.getAmountOwedTextbox2MPA().enterTextField("4000");
//        this.getAmountOwedTextbox2MPA().enter();
        this.getAmountOwedTextbox2MPA().tab();
        GenericMethod_cvp.implicitWait(6000);
...
//        this.getDetailedViewLink2().click();
        ...
        this.getAddaDebtButton().click();
        getBrowser().sleep(getBrowser().getTimeout() / 10);
        this.getCreditorFromDropDownfordebt3().enterCharByChar("Natwest");
        this.gettabClick().click();
        GenericMethod_cvp.implicitWait(10000);
        this.getDebtTypFromDropdown3().enterTextField("Credit card");
        tabdebtsPrimary.click();
        GenericMethod_cvp.implicitWait(10000);
...
//        this.getDetailedViewLinkfordebt3().click();
        ...
        this.getAddaDebtButton().click();
        GenericMethod_cvp.implicitWait(10000);
        this.getCreditorType4Name().enterTextField("Natwest");
        this.gettabClick().click();
        GenericMethod_cvp.implicitWait(10000);
        this.getDebtTypFromDropdown4().enterTextField("Overdraft");
        tabdebtsPrimary.click();
        GenericMethod_cvp.implicitWait(10000);
...
//        creaditorDropDownValueButton.click();
 ...
 //       DebtTypeDropDownValueButton.click();
        ...
        this.getAmountOwedTextFieldNatwest().clear();
        GenericMethod_cvp.implicitWait(4000);
        this.getAmountOwedTextFieldNatwest().enterTextField("8000");
...
//        //creditor2//LiabilityDropdown2
        this.getAddaDebtButton().click();
        GenericMethod_cvp.implicitWait(5000);
        this.getCreditorFromutoComplete2().enterTextThenSelectFromAutoComplete("Natwest");
//        this.getCreditorFromDropDown2().enterText("Natwest");
        this.enter();
//        creaditorDropDownValueButton.click();
        GenericMethod_cvp.implicitWait(5000);
        this.getDebtTypFromAutoComplete2().enterTextThenSelectFromAutoComplete("Credit card");
        this.enter();
        GenericMethod_cvp.implicitWait(5000);
//        DebtTypeDropDownValueButton.click();
        this.getAmountOwnedTextBoxNatwest2().clear();
        GenericMethod_cvp.implicitWait(5000);
        this.getAmountOwnedTextBoxNatwest2().enterTextField("5000");
        GenericMethod_cvp.implicitWait(5000);
...
//        GenericMethod_cvp.selectByIndex(LiabilityDropdown2, 2);
        this.getLiabilityutoComplete2().selectFromDropdownByIndex(2);
        GenericMethod_cvp.implicitWait(5000);
//        this.getDetailedViewLink3().click();
