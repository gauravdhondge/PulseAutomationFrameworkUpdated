...
public class YourPriorityPayments_ArrangementsforPriorityArrearsPage extends Control {
	...
	private Button WouldYouLikePutSavingsForMoneyNo;

	private Button SmallSavingAccountPageContinueButton;
    private Button SavingsPageContinue;
    private Button previousDebtSolutions;
    private Dropdown previousSolutionNoReason;

	private Button MonyeAsideForSaving;
	...
	private Button getWouldYouLikePutSavingsForMoneyNo(){return WouldYouLikePutSavingsForMoneyNo; }

	private Button getSmallSavingAccountPageContinueButton(){return SmallSavingAccountPageContinueButton; }
	...
	public YourPriorityPayments_ArrangementsforPriorityArrearsPage() {
		...
		WouldYouLikePutSavingsForMoneyNo=new Button(By.xpath("//label[text()='No']"));
		SmallSavingAccountPageContinueButton=new Button(By.xpath("//button[text()='Continue']"));
...
//		genericMethodsCvp.implicitWait(4000);
//		this.getWouldYouLikePutSavingsForMoneyNo().click();
//		genericMethodsCvp.implicitWait(4000);
//		getSmallSavingAccountPageContinueButton().click();
//		genericMethodsCvp.implicitWait(4000);
	}
