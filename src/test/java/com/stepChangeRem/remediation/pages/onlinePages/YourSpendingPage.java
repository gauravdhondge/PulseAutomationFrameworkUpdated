...
public YourSpendingPage(){
            ...
            AreYouBehindWithPaymentsNoRb = new Button(By.xpath("(//label[@class='rb_standard rb_standard radioLabel'])[2]"));
            ...
            AreYouBehindWithPaymentsNoRbForBuildingandContents = new Button(By.xpath("(//label[@class='rb_standard rb_standard radioLabel'])[2]"));
