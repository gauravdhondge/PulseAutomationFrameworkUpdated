...
public class YourRecommendedSolutionPage extends Control {
    ...
    private Checkbox InterestedApplyingForMAPCheckBox;
    ...
    public Checkbox getInterestedApplyingForMAPCheckBox() { return InterestedApplyingForMAPCheckBox; }
    ...
    public YourRecommendedSolutionPage(){
        ...
        InterestedApplyingForMAPCheckBox = new Checkbox(By.xpath("(//label[@class=' cb_standard'])[1]"));
    ...
    public void SelectMinimalAssetProcessPlan(){
        GenericMethods_cvp.implicitWait(2000);
        this.getInterestedApplyingForMAPCheckBox().click();
