...
public class DashBoardPageOnline extends Control {
    ...
    private Button PriorityPaymentButton;
    ...
    private Button PriorityButtonContinueButton;
    ...
    public Button getPriorityPaymentButton() {
        return PriorityPaymentButton;
    }

    public Button getPriorityButtonContinueButton() {
        return PriorityButtonContinueButton;
    }
...
//    x-paths for 89954,89955,89963;  Please Make Sure While Executing
        ...
        PriorityPaymentButton = new Button(By.xpath("(//div[text()='Your priority payments'])[2]"));
        PriorityButtonContinueButton = new Button(By.xpath("//button[text()='Continue']"));
...
//        switchToActiveFrame();
    ...
    public void SelectingYourPriorityPayments() {
        ...
        this.getPriorityPaymentButton().click();
        GenericMethods_cvp.implicitWait(4000);
        this.getPriorityButtonContinueButton().click();
