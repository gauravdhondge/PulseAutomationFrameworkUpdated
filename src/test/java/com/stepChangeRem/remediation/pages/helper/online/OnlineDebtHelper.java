...
public class OnlineDebtHelper extends Control {
    ...
    private Button DebtAddedEverythingYes;

    private Button DebtAddedEverythingNo;
    ...
    private Checkbox DontHaveThisCost;



    public Checkbox getDontHaveThisCost(){

        return DontHaveThisCost= new Checkbox(By.xpath("(//input[@name='$PD_ExpenditureCategoryList$ppxResults$l1$ppxResults$l1$pIsItemNotApplicable'])[2]"));
    }
...
//    }
    ...
    public TextField getMortagagePaymentAmount() {
        return mortagagePaymentAmount = new TextField(By.xpath("(//input[contains(@name,'$ppxResults$l1$pAmount')])[2]"));
    }
    ...
    public Button getDebtAddedEverythingYes() {
        return DebtAddedEverythingYes=new Button(By.xpath("(//label[@class='rb_standard rb_standard radioLabel'])[1]"));
    }

    public Button getDebtAddedEverythingNo() {
        return DebtAddedEverythingNo=new Button(By.xpath("(//label[@class='rb_standard rb_standard radioLabel'])[2]"));
    }
   ...
   //     return finishedDebts=new Button(By.xpath("//input[@id='47f6b90aComplete']"));
...
//      this.getContinueButton().click();
    ...
    private void fillMortgageDetails(List<DebtsFields> debitDetails, int i, int actualPostition) {
        if(debitDetails.get(i).getIsDebtTypeMortagage()!=null && !debitDetails.get(i).getIsDebtTypeMortagage().isEmpty()&&debitDetails.get(i).getIsDebtTypeMortagage().equalsIgnoreCase("true")) {
            ...
            verifyOverLayDisplayed();
            this.getMortagagePaymentAmount().enterText(debitDetails.get(i).getMortagagePaymentAmount());
            verifyOverLayDisplayed();
