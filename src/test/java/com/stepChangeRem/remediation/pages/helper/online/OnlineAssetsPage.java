...
public class OnlineAssetsPage extends Control {
    ...
    private TextField EstimatedAssetValue;
    private Button WhoOwnsThis;

    private Button SplitEquallyBetweenYou;


    public Button getSplitEquallyBetweenYou() {
        return SplitEquallyBetweenYou=new Button(By.xpath("(//label[@class='rb_standard rb_standard radioLabel'])[7]"));
    }
    public Button getWhoOwnsThis() {
        return WhoOwnsThis=new Button(By.xpath("(//label[@class='rb_standard rb_standard radioLabel'])[3]"));
    }

    public Button getMainHome() {
        return MainHome=new Button(By.xpath("//div[text()='Main home']"));
    }

    public TextField getEstimatedAssetValue() {
        return EstimatedAssetValue=new TextField(By.xpath("//input[contains(@name,'$ppxResults$l1$pAmount')]"));
    }
    ...
    {
        new Button(By.xpath("//div[text()='Main home']")).click();
...
//            if(finalQuestionsFields.getMortgageOwner()!=null)
    ...
    public void fillAssetsFormFinalQuestionsPage89950() throws InterruptedException {
         this.getMainHome().click();
         Thread.sleep(3000);
//         this.getEstimatedAssetValue().enterText("50000");
//         Thread.sleep(3000);
         this.getWhoOwnsThis().click();
         Thread.sleep(3000);
         this.getSplitEquallyBetweenYou().click();
         this.getAddButton().click();
