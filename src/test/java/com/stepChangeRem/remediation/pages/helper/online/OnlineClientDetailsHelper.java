...
public class OnlineClientDetailsHelper extends EstablishClientNeedsPage{
  ...
  //  private TextField surname;
    ...
    public TextField getReferredBY() {
        return referredBY=new TextField(By.xpath("//input[@name='$PpyWorkPage$pReferrer$pDescription']"));
    }
...
//    }
    ...
    public Button getWhereDoTheyLive(int index, String whereDoTheyLiveValue) {
        return whereDoTheyLive=new Button(By.xpath("(//label[@class='rb_standard rb_standard radioLabel'])[2]/../label[.='"+whereDoTheyLiveValue+"']"));
    }
...
//        switchToActiveFrame();
        for (int noOfClients = 0; noOfClients < clientNeedsList.size(); noOfClients++) {
            ...
            this.getReferredBY().enterTextField(client.get("referredBY"));
