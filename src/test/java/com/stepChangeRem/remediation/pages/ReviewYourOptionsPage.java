...
public class ReviewYourOptionsPage extends Control{
	...
	private Button FindOutMoreButton89937;
	...
	private Checkbox PaymentSuspensionCheckBox;
	private Checkbox DMPCheckbox89929;
	private Button paymentSuspensionFindOut;
	private Button droFindOut;

	private Button FindOut89930;

	private Button FindOut89929;
	...
	public Checkbox getDMPCheckbox89929() {
		return DMPCheckbox89929=new Checkbox(By.xpath("(//input[@type='checkbox'])[1]"));
	}
	...
	public Checkbox getPaymentSuspensionCheckBox89930() {
		return PaymentSuspensionCheckBox=new Checkbox(By.xpath("(//input[@type='checkbox'])[1]"));
	}

	public Button getDroFindOut() {
		return droFindOut=new Button(By.xpath("(//button[.='Find out more'])[3]"));
	}

	public Button getFindOut89930() {
		return FindOut89930=new Button(By.xpath("(//button[.='Find out more'])[1]"));
	}

	public Button getFindOut89929() {
		return FindOut89929=new Button(By.xpath("(//button[.='Find out more'])[1]"));
	}
...
//
	...
	private Checkbox InterestedApplyingPaymentSuspension;
	...
	public Button getFindOutMoreButton89937() {return FindOutMoreButton89937;}
...
//    public Div getRecommendedSolutionDiv() {return RecommendedSolutionDiv; }
	...
	public Checkbox getInterestedApplyingPaymentSuspension(){return InterestedApplyingPaymentSuspension;}
	...
	public Button getContinueButtonYourRecommondedSolution(){return ContinueButtonYourRecommondedSolution;}
	public Div getDebtPaymentProgrammeDivText(){return DebtPaymentProgrammeDivText; }

	public ReviewYourOptionsPage()
	{
		InterestedApplyingPaymentSuspension=new Checkbox(By.xpath("//label[text()='I’m interested in applying for payment suspension']"));
		...
		FindOutMoreButton89937=new Button(By.xpath("(//button[text()='Find out more'])[1]"));
		ReturnToDebtSolutionsBtn=new Button(By.xpath("//button[text()='Return to debt solutions']"));
		ContinueButtonYourRecommondedSolution = new Button(By.xpath("//button[@name='PresentSolutions_pyWorkPage_50']"));
...
//		AAssert.assertEquals(Expected, Actualvalue);
	...
	public void selectPaymentSuspSolution89937() {
		genericMethodsCvp.implicitWait(3000);
		switchToActiveFrame();
		this.getInterestedApplyingPaymentSuspension().click();
		this.getFindOutMoreButton89937().click();
		this.getReturnToDebtSolutionsBtn().click();
		genericMethodsCvp.implicitWait(5000);
