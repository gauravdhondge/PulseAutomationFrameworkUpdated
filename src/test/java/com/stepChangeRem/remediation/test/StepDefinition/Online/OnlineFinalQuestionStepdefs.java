...
public class OnlineFinalQuestionStepdefs {
    ...
    @And("^User Navigated to Final Questions and Continues and Fill Mortgage Details89950$")
    public void userNavigatedToFinalQuestionsAndContinuesAndFillMortgageDetails89950() throws InterruptedException {
        GenericMethods_cvp.implicitWait(4000);
        houseHolds.getFinalQuestion().click();
        GenericMethods_cvp.implicitWait(4000);
        assets.fillAssetsFormFinalQuestionsPage89950();
        GenericMethods_cvp.implicitWait(4000);
        helper.getContinueButton().click();
        GenericMethods_cvp.implicitWait(4000);
        houseHolds.clickOnNoButtons();
