...
//		genericMethods.implicitWait(1000);
		Thread.sleep(4000);
...
//		genericMethods.implicitWait(5000);
//		getDriver().findElement(By.xpath("(//div[text()='Understand your situation'])[1]")).click();
		genericMethods.implicitWait(5000);
		yourDashBordPageObj.ClickOnYourDebtsButton();
...
//		getBrowser().sleep(5000);
		...
		genericMethods.implicitWait(5000);
		yourDebtPageObj.getAreYouBehindWithpayementNoButton89939().click();
		genericMethods.implicitWait(5000);
...
//	    yourSpendingFixedPage.getContinueYourFixedSpendingButton().click();
		...
		genericMethods.implicitWait(5000);
		getBrowser().sleep(6000);
	    yourSpendingFlexiblePage.getMonthlyFoodAndGroceries().enterText("192");
